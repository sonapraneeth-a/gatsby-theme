          ...
          <div className={footer_class}>
            <p style={{margin: 0}}>
              ...
              { this.props.linkedin_username != null &&
                <a href={"https://www.linkedin.com/in/"+linkedin_username} target="_blank" rel="noopener"><i className="fab fa-linkedin-in" style={{color: 'hsl(201, 100%, 35%)', padding: '0.2rem 0.5rem'}}></i></a>
              }
              { this.props.twitter_username != null &&
                <a href={"https://twitter.com/"+twitter_username} target="_blank" rel="noopener"><i className="fab fa-twitter" style={{color: 'hsl(203, 89%, 53%)', padding: '0.2rem 0.5rem'}}></i></a>
              }
              { this.props.github_username != null &&
                <a href={"https://github.com/"+github_username} target="_blank" rel="noopener"><i className="fab fa-github" style={{color: 'hsl(214, 50%, 50%)', padding: '0.2rem 0.5rem'}}></i></a>
              }
