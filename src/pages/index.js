    ...
    return (
      <div>
        ...
        <ProfileCard
          ...
          <a href="http://iitj.ac.in/department/index.php?id=cse" target="_blank"> Computer Science and Engineering</a> from <a href="http://iitj.ac.in/" target="_blank">IIT Jodhpur</a> in April 2015.</p>
          <p>I like to work in areas involving Computer Vision, Image Processing and 
    Machine Learning. You can have a look at my projects <Link to="/projects/">here</Link>.</p></div>}
        />
      </div>
    )
  }
